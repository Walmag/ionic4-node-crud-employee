    ...
    ["edit-employee-edit-employee-module"], {
        ...
        /***/
            ...
            var EditEmployeePage = /** @class */ (function() {
                function EditEmployeePage(employeeAPI, actRoute, router, fb) {
                ...
                EditEmployeePage.prototype.getEmployeeData = function(id) {
                    var _this = this;
                    this.employeeAPI.getEmployee(id).subscribe(function(res) {
                        _this.updateEmployeeForm.setValue({
                            employee_name: res['employee_name'],
                            birthday: res['birthday']
                        });
                    });
                };
                EditEmployeePage.prototype.updateForm = function() {
                    var _this = this;
                    if (!this.updateEmployeeForm.valid) {
                        ...
                        this.employeeAPI.updateEmployee(this.id, this.updateEmployeeForm.value)
                            .subscribe(function(res) {
                                console.log(res);
                                _this.updateEmployeeForm.reset();
