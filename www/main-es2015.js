...
const routes = [
    ...
    {
        path: 'add-employee',
        loadChildren: () => Promise.all(/*! import() | add-employee-add-employee-module */[__webpack_require__.e("common"), __webpack_require__.e("add-employee-add-employee-module")]).then(__webpack_require__.bind(null, /*! ./add-employee/add-employee.module */ "./src/app/add-employee/add-employee.module.ts")).then(m => m.AddEmployeePageModule)
    },
    {
        path: 'edit-employee/:id',
        loadChildren: () => Promise.all(/*! import() | edit-employee-edit-employee-module */[__webpack_require__.e("common"), __webpack_require__.e("edit-employee-edit-employee-module")]).then(__webpack_require__.bind(null, /*! ./edit-employee/edit-employee.module */ "./src/app/edit-employee/edit-employee.module.ts")).then(m => m.EditEmployeePageModule)
    },
];
