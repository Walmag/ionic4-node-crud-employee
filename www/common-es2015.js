...
let EmployeeService = class EmployeeService {
    ...
    getEmployee(id) {
        return this.http.get('http://localhost:3000/api/get-employee/' + id)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(_ => console.log(`Employee fetched: ${id}`)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.handleError(`Get Employee id=${id}`)));
    }
    getEmployeeList() {
        return this.http.get('http://localhost:3000/api')
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(employees => console.log('Employees fetched!')), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.handleError('Get Employees', [])));
    }
    updateEmployee(id, employee) {
        return this.http.put('http://localhost:3000/api/update-employee/' + id, employee, this.httpOptions)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(_ => console.log(`Employee updated: ${id}`)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.handleError('Update Employee')));
    }
    deleteEmployee(id) {
        return this.http.delete('http://localhost:3000/api/delete-employee/' + id, this.httpOptions)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(_ => console.log(`Employee deleted: ${id}`)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.handleError('Delete Employee')));
    }
